...
[![Run CI](https://github.com/launchdarkly/php-server-sdk-redis-phpredis/actions/workflows/ci.yml/badge.svg?branch=1.x)](https://github.com/launchdarkly/php-server-sdk-redis-phpredis/actions/workflows/ci.yml)
